...
const modalRegex = /\{\/\* Coach Modal \*\/\}[\s\S]*?\{\/\* Review Modal \*\/\}|\{\/\* Coach Modal \*\/\}[\s\S]*?(?=\{showReviewModal && \()/;
      ...
      {selectedCoach && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-4xl bg-stone-900 rounded-2xl md:rounded-3xl overflow-hidden shadow-2xl flex flex-col md:flex-row max-h-[90vh]">
            ...
            <div className="w-full md:w-1/2 h-[250px] sm:h-[300px] md:h-auto shrink-0 relative">
