...
const pattern = /  return \(\s*<div className="min-h-screen bg-\[var\(--color-neu-base\)\] flex flex-col md:flex-row">[\s\S]*?\{\/\* User Profile Card \*\/\}\s*<Card variant="flat" className="hidden md:flex items-center gap-4 p-4 mt-auto">/;
